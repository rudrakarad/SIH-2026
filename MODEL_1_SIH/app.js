...
function toggleVoiceML() {
    ...
    speechRecognizerML.lang = typeof getSpeechLang === "function" ? getSpeechLang() : "en-IN";
...
function runClientSideMLClassification(msg) {
    ...
    if (/(water|flood|rain|submerged|river|overflow|drown|waterlogging|basement|drain|underwater|lake|बाढ़|पानी|पूर)/.test(m)) scores.Flood += 3;
    if (/(fire|flame|smoke|cylinder|blast|explosion|burn|building fire|trapped in fire|आग|धुआं|धूर)/.test(m)) scores.Fire += 3;
    if (/(quake|earthquake|shaking|tremor|collapse|debris|crack|wall|rubble|भूकंप|धरणीकंप)/.test(m)) scores.Earthquake += 3;
    if (/(landslide|mudslide|mountain|slope|rockfall|ghat|hillside|भूस्खलन|धसकणे)/.test(m)) scores.Landslide += 3;
    if (/(cyclone|storm|wind|gale|hurricane|typhoon|roof|tree fall|तूफान|चक्रवात|वादळ)/.test(m)) scores.Cyclone += 3;
    ...
    if (/(trapped|children|elderly|submerged|unconscious|immediately|collapsed|rescue|dying|urgent|फंसे|तातडीने)/.test(m)) {
        predicted_urgency = "Critical";
        urgency_confidence = 88.4;
    } else if (/(rising|flooded|heavy|blocked|spreading|highway|danger|गंभीर)/.test(m)) {
        predicted_urgency = "High";
        urgency_confidence = 79.2;
    } else if (/(playground|pool|minor|small|inspection|सामान्य)/.test(m)) {
...
function toggleVoiceChat() {
    ...
    speechRecognizerChat.lang = typeof getSpeechLang === "function" ? getSpeechLang() : "en-IN";
...
async function sendChatMessage() {
    ...
    botBubble.innerHTML = `
        ...
        <div class="bubble-content"><p><i class="fa-solid fa-spinner fa-spin"></i> ${escapeHtml(getTranslation('chat_thinking', 'SurakshAI is thinking...'))}</p></div>
    `;
    ...
    if (useServerBackend) {
        try {
            const res = await fetch(`${API_BASE}/api/chatbot`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ message: msgText, language: typeof currentLanguage !== 'undefined' ? currentLanguage : 'en' })
            });
            if (res.status === 200) {
                const data = await res.json();
    ...
    const reply = getClientSideChatbotResponse(msgText, typeof currentLanguage !== 'undefined' ? currentLanguage : 'en');
    botBubble.querySelector(".bubble-content").innerHTML = `
...
function getClientSideChatbotResponse(q, lang = "en") {
    const m = q.toLowerCase();

    if (lang === "hi") {
        if (/(बाढ़|पानी|जल|flood)/.test(m)) {
            return "🌊 **बाढ़ सुरक्षा प्रोटोकॉल**:\n1. तुरंत ऊंचे स्थान या मजबूत इमारत की ऊपरी मंजिलों पर जाएं।\n2. बहते पानी में चलने या गाड़ी चलाने से बचें (15 सेमी पानी आपको बहा सकता है)।\n3. मुख्य बिजली ब्रेकर और एलपीजी सिलेंडर का रेगुलेटर बंद करें।\n4. नाव से निकासी के लिए एनडीआरएफ/एसडीआरएफ हेल्पलाइन **112** या **1078** पर कॉल करें।";
        }
        if (/(भूकंप|कंपन|earthquake)/.test(m)) {
            return "🚨 **भूकंप सुरक्षा प्रोटोकॉल**:\n1. मजबूत मेज या डेस्क के नीचे **झुकें, ढकें और पकड़ें (Drop, Cover, Hold)**।\n2. कांच की खिड़कियों और बाहरी दीवारों से दूर रहें।\n3. यदि आप बाहर हैं, तो इमारतों और बिजली के तारों से दूर खुले मैदान में जाएं।\n4. फंसे या घायल होने पर राष्ट्रीय आपातकालीन नंबर **112** पर कॉल करें।";
        }
        if (/(आग|धुआं|fire)/.test(m)) {
            return "🔥 **अग्नि आपातकालीन प्रोटोकॉल**:\n1. तुरंत सीढ़ियों का उपयोग करके बाहर निकलें — **लिफ्ट का उपयोग न करें**।\n2. जहरीले धुएं से बचने के लिए फर्श के करीब रेंगें।\n3. यदि कपड़ों में आग लग जाए: **रुकें, गिरें और रोल करें**।\n4. फायर ब्रिगेड **101** या **112** पर कॉल करें।";
        }
        return `🚨 **'${q}' के लिए सुरक्षाAI मार्गदर्शन**:\n1. शांत रहें और अपने आस-पास के वातावरण का आकलन करें।\n2. खतरनाक संरचनाओं से दूर सुरक्षित स्थान पर जाएं।\n3. सहायता के लिए **112** या **1078** पर संपर्क करें।`;
    }

    if (lang === "mr") {
        if (/(पूर|पाणी|flood)/.test(m)) {
            return "🌊 **पूर सुरक्षा प्रोटोकॉल**:\n1. ताबडतोब उंच ठिकाणी किंवा मजबूत इमारतीच्या वरच्या मजल्यावर जा.\n2. वाहत्या पाण्यातून चालणे किंवा गाडी चालवणे टाळा.\n3. मुख्य विजेचे स्विच आणि गॅस सिलिंडर बंद करा.\n4. बोट बच्चावासाठी एनडीआरएफ हेल्पलाइन **112** किंवा **1078** वर कॉल करा.";
        }
        if (/(भूकंप|धरणीकंप|earthquake)/.test(m)) {
            return "🚨 **भूकंप सुरक्षा प्रोटोकॉल**:\n1. मजबूत टेबलाखाली **खाली बसा, झाका आणि घट्ट धरा (Drop, Cover, Hold)**.\n2. काचांच्या खिडक्या आणि भिंतींपासून दूर राहा.\n3. घराबाहेर असल्यास मोकळ्या मैदानात जा.\n4. आपत्कालीन मदतीसाठी **112** वर कॉल करा.";
        }
        if (/(आग|धूर|fire)/.test(m)) {
            return "🔥 **आग आपत्कालीन प्रोटोकॉल**:\n1. लिफ्टचा वापर न करता पायऱ्यांवरून ताबडतोब बाहेर पडा.\n2. धुरापासून वाचण्यासाठी जमिनीसरपट रांगा.\n3. अग्निशामक दलासाठी **101** किंवा **112** वर कॉल करा.";
        }
        return `🚨 **'${q}' साठी सुरक्षाAI मार्गदर्शन**:\n1. शांत राहा आणि सुरक्षित ठिकाणी जा.\n2. धोक्याच्या भागापासून दूर राहा.\n3. मदतीसाठी **112** किंवा **1078** वर संपर्क साधा.`;
    }
